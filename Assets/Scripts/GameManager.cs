...
public class GameManager : MonoBehaviour {
	...
	private string mainScoreDisplayTemplate;
	...
	void Start () {
		...
		mainScoreDisplayTemplate = mainScoreDisplay.text;
	...
	public void Collect(int amount) {
		score += amount;
		if (canBeatLevel) {
			mainScoreDisplay.text = mainScoreDisplayTemplate + score.ToString () + " of "+beatLevelScore.ToString ();
		} else {
			mainScoreDisplay.text = mainScoreDisplayTemplate + score.ToString ();
		}
